...
```{r presentation_figures, fig.width=12, fig.height=4.5, eval=FALSE}
...
```
```{r presentation_family_stats, fig.width = 7, fig.height = 6, eval=FALSE}
ggplot(mm[mm$metric %like% 'pair|gt1', ], aes(value, sample, fill = metric)) +
        geom_bar(stat='identity', position='dodge') +
        theme_bw() +
...
```{r presentation_comparison, fig.width=12, fig.height=4.5, eval=FALSE}
mt <- mm
