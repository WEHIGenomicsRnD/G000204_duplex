...
Shows the number of single-read families divided by the total number of families. As suggested by [Stoler et al.](https://doi.org/10.1186/s13059-016-1039-4), this metric can server as a proxy for error rate, as (uncorrected) barcode mismatches will manifest as single-read familites. The lower the fraction of singletons, the better.
