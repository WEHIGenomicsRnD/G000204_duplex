...
mdup <- load_markdup_data(markdup_dir, sample_names[sample_names !="10-K12Rep1-HFVGHDSX3"])
...
metrics$duplicate_rate <- c(as.numeric(mdup)[1:2], NA, as.numeric(mdup)[3:8])
...
**The 0.1% spike-in sample fails when running picard MarkDuplicates, so those results are not shown**
